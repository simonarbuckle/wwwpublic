					...
					<div class="columns main-page">
						<article class="column guides">
							...
							<div class="container">
								<div class="guide left">
									...
									Take a look to the sample:
										<ul>
											<li>Inside the first sample you can see how simple is to create the Hello World application in aria templates, using the bootstrap to load the framework and to load the <a href="/usermanual/latest/writing_templates">template</a> with the message.</li>
											<li>Inside the second sample you can see how to use a <a href="/usermanual/latest/template_scripts">Template Script</a> to interact with the template and how to give some style, using a <a href="/usermanual/latest/css_templates">CSS Template</a>, to your template.</li>											
										</ul>	
									</p>									
								</div>						
								<div class="guide right">								
									...
									The guide loads the template and define the module controller inside the bootstrap. It uses the <a href="/usermanual/latest/link">@aria:Link</a> widget to load the data.<br/>
									In this example we simulate the server using a <a href="/usermanual/latest/filters">filter</a> and an xml file. The filter intercepts the JSON request and provides the response taking the data from data.xml.<br/>
									To display the treeview the guide uses a <a href="/usermanual/latest/refresh#section-automatic-refresh">section with automatic refresh</a> bound to the data model.</p>									
								</div>
								<div class="footer">
									<span class="left">
							...
							<div class="guide withImg">
								...
								This application is created by four <a href="/usermanual/latest/refresh#section-automatic-refresh">sections</a> (level, timer, board, banner) and all of them are bound to the data model (level, timer, moves). To manage the interaction with the user the app uses the <a href="/usermanual/latest/dom_events#mouse-events">on click DOM event</a> and to generate the colored board uses the <a href="/usermanual/latest/writing_templates#foreach">foreach</a> statement.</p>
								<p>
