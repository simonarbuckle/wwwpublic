...
&nbsp; &nbsp; <span style="color: #F8F8F8;">}</span></div></div></div>
									<p class="note"><b>Note:</b> To check how to use $dataReady take a look at <a href="/usermanual/Template_Scripts#Intercepting_template_lifecycle_phases">this page</a>.</p>
