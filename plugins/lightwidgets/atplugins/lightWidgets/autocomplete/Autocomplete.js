...
(function () {
    ...
    Aria.classDefinition({
        $classpath : basePath + "autocomplete.Autocomplete",
        ...
        $dependencies : ["aria.utils.Dom", "aria.utils.Event", "aria.html.controllers.Suggestions",
                basePath + "LazyLoader", basePath + "autocomplete.AutocompleteCfgBeans", "aria.utils.Json"],
        /**
        ...
        $constructor : function (cfg, ctxt, lineNumber) {
             ...
             * @type String
             */
            this.$cfgBean = basePath + "autocomplete.AutocompleteCfgBeans.Properties";
            ...
            nspace.LazyLoader.register(this.$classpath, {
                classes : [basePath + "autocomplete.AutocompleteDropDown"],
