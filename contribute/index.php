				...
				<div class="wrapper">
					<div class="columns main-page two">
						<article class="column">
							...
							<h3>Contribute to Aria Templates</h3>
							
							<h4>Go to Github</h4>
							<p>The source code is hosted at <a href="http://github.com/ariatemplates">Github</a>. Just fork the repository and you are ready
							...
							Keep in mind that an ideal bug report should contains a clear description of what is going wrong, and at least a few words about your expected behavior.<br />
							A supplementary test case would be perfect!</p>
						</article>
						<aside class="column sidebar">
							<h4>Code source</h4>
							<div class="onsale" style="position: relative">
								<a href="http://github.com/ariatemplates/ariatemplates"><img style="position: absolute; top: 0; right: 0; border: 0;" src="https://s3.amazonaws.com/github/ribbons/forkme_right_red_aa0000.png" alt="Fork me on GitHub"></a>
								<img src="/images/github_socialite.jpg" style="margin-top: -34px" />
							</div>
							<div>
								<h4>Issues</h4>
								<p>You spotted an issue? Open a new ticket on our <a href="http://github.com/ariatemplates/ariatemplates/issues">Github issue tracker</a></p>
							</div>
						</aside>
